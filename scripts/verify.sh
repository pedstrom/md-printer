...
[[ "$(plutil -extract CFBundleShortVersionString raw Resources/Info.plist)" == "1.0.4" ]]
[[ "$(plutil -extract CFBundleVersion raw Resources/Info.plist)" == "5" ]]
...
[[ "$(plutil -extract CFBundleShortVersionString raw "build/Markdown Printer.app/Contents/Info.plist")" == "1.0.4" ]]
[[ "$(plutil -extract CFBundleVersion raw "build/Markdown Printer.app/Contents/Info.plist")" == "5" ]]
