...
[[ "$(plutil -extract CFBundleShortVersionString raw Resources/Info.plist)" == "1.1.0" ]]
[[ "$(plutil -extract CFBundleVersion raw Resources/Info.plist)" == "6" ]]
...
[[ "$(plutil -extract CFBundleShortVersionString raw "build/Markdown Printer.app/Contents/Info.plist")" == "1.1.0" ]]
[[ "$(plutil -extract CFBundleVersion raw "build/Markdown Printer.app/Contents/Info.plist")" == "6" ]]
