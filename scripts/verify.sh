...
plutil -lint \
  QuickLookExtension/MarkdownPrinterQuickLook/MarkdownPrinterQuickLook.entitlements \
  >/dev/null
[[ "$(plutil -extract CFBundleShortVersionString raw Resources/Info.plist)" == "1.4.2" ]]
[[ "$(plutil -extract CFBundleVersion raw Resources/Info.plist)" == "11" ]]
...
[[ "$(plutil -extract CFBundleShortVersionString raw "build/Markdown Printer.app/Contents/Info.plist")" == "1.4.2" ]]
[[ "$(plutil -extract CFBundleVersion raw "build/Markdown Printer.app/Contents/Info.plist")" == "11" ]]
