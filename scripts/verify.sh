...
required_files=(
  ...
  iOS/MarkdownPrinterIOSTests/MarkdownSearchIndexTests.swift
  iOS/MarkdownPrinterIOSTests/MobileDocumentAccessTests.swift
  iOS/MarkdownPrinterIOSTests/MobileDocumentSessionTests.swift
  iOS/MarkdownPrinterIOSTests/MobilePDFExporterTests.swift
  iOS/MarkdownPrinterIOSTests/MobileMarkdownFileDocumentTests.swift
  iOS/MarkdownPrinterIOSUITests/MarkdownPrinterIOSUITests.swift
...
plutil -lint \
  QuickLookExtension/MarkdownPrinterQuickLook/MarkdownPrinterQuickLook.entitlements \
  >/dev/null
[[ "$(plutil -extract CFBundleShortVersionString raw Resources/Info.plist)" == "1.4.3" ]]
[[ "$(plutil -extract CFBundleVersion raw Resources/Info.plist)" == "12" ]]
...
COVERAGE_REPORT="$(xcrun llvm-cov report "$TEST_BINARY" \
  ...
  -ignore-filename-regex='(/Tests/|MarkdownPrinterPackageTests.derived|Sources/MarkdownPrinter/MarkdownPrinter.swift|Sources/MarkdownPrinterCLI/MarkdownPrinterCLI.swift|Sources/MarkdownPrinterUI/MarkdownPrinterView.swift|Sources/MarkdownPrinterUI/MarkdownPrinterHelpView.swift|Sources/MarkdownPrinterUI/PDFPreviewView.swift|Sources/MarkdownPrinterUI/ExportSettingsView.swift|Sources/MarkdownPrinterUI/DocumentCommands.swift|Sources/MarkdownPrinterUI/DocumentWindowRestorationAttachmentView.swift)')"
...
[[ "$(plutil -extract CFBundleShortVersionString raw "build/Markdown Printer.app/Contents/Info.plist")" == "1.4.3" ]]
[[ "$(plutil -extract CFBundleVersion raw "build/Markdown Printer.app/Contents/Info.plist")" == "12" ]]
