...
- Resolve local relative images against the Markdown file's folder and preserve aspect ratio within the printable area. Keep remote images user-initiated on Mac, load secure remote images automatically in the full iPhone viewer, store downloads only in the disposable app cache, and retain readable placeholders when unavailable.
