...
public struct RendererConfiguration: Equatable {
    ...
    public init(
        ...
        headingFontSizes: [CGFloat] = HeadingTypography.printSizes,
        pageSize: CGSize = CGSize(width: 612, height: 792),
        pageMargins: NSEdgeInsets = NSEdgeInsets(top: 54, left: 54, bottom: 54, right: 54),
        textColor: NSColor = .black,
        secondaryTextColor: NSColor = NSColor(calibratedWhite: 0.5, alpha: 1),
        accentColor: NSColor = NSColor(calibratedRed: 0, green: 0.48, blue: 1, alpha: 1),
